        ...
        private void cmdGravar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    parlog[0] = invoice.get_Filial();
                    parlog[1] = invoice.get_Tipodoc();
                    parlog[2] = invoice.get_Serie();
                    parlog[3] = invoice.get_NumDoc();

                    PriEngine.Platform.Log.ActualizaLinha("GCP", "DocVenda", EnumTipoOperLog., "Fatura com origem em aplicação Externa", parlog);
